...
import { deleteDocument, getAllDocuments, getDocumentById, getRecentDocument, updateDocument, uploadDocument } from '../controllers/documents.js';
...
documentRouter.get('/recent' , getRecentDocument);
